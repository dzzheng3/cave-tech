...
public class AddPersonActivity$$ViewInjector {
  public static void inject(Finder finder, final cavetech.com.challenge.takehome.activities.AddPersonActivity target, Object source) {
    View view;
    ...
    view = finder.findRequiredView(source, 2131558513, "field 'fabDelete' and method 'onViewClicked'");
  ...
  public static void reset(cavetech.com.challenge.takehome.activities.AddPersonActivity target) {
